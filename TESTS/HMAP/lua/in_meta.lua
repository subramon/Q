...
M[#M+1] = { name = "data_file_name", qtype = "SC", width = 32, is_load = false  }
M[#M+1] = { name = "model_file_name", qtype = "SC", width = 32, is_load = false }
...
M[#M+1] = { name = "t_model_building", qtype = "I8", has_nulls = false }
M[#M+1] = { name = "t_data_created", qtype = "I8", has_nulls = false }
M[#M+1] = { name = "t_model_created", qtype = "I8", has_nulls = false }
return M
