...
Output(buffer,weight,last_packet,last_packet_size,siz,num_quantiles,quantiles,b,k): This function takes as input the 2d buffer array, the weight array and the last packet and answers quantile queries.
...
weight: Weight array which contains the weight information of each buffer in the 2d buffer array
