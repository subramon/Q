...
#line 136 "snazzle.tab.c" /* yacc.c:339  */
...
#line 228 "snazzle.tab.c" /* yacc.c:355  */
};
...
#line 243 "snazzle.tab.c" /* yacc.c:358  */
...
{
       0,   137,   137,   142,   151,   162,   173,   188,   204,   221,
     241,   264,   285,   309,   364,   376,   392,   417,   450,   466,
     482,   498,   529
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "FP", "STRING", "VERB", "OPTIONS",
  "KEYWORD", "PROPERTY", "VBAR", "MINUS", "PLUS", "DOT", "QMARK", "COLON",
  "EQUALS", "COMMA", "LT", "GT", "ASTERISK", "NOOP", "LEQ", "GEQ",
  "ASSIGN", "ADDTO", "MOVE", "GEQANDLEQ", "GTANDLT", "LEQORGEQ", "LTORGT",
  "OPEN_CURLY", "CLOSE_CURLY", "OPEN_SQUARE", "CLOSE_SQUARE", "OPEN_ROUND",
  "CLOSE_ROUND", "ADD_TBL", "ADD_FLD", "DEL_TBL", "DEL_FLD", "$accept",
  "command", YY_NULLPTR
};
#endif
...
{
      13,   -13,    -3,    -1,     5,    17,     1,    18,     3,    21,
      23,    16,    19,    24,    -6,   -14,    -9,   -14,    26,   -14,
     -14,    29,    30,    28,   -14,    31,   -14,    32,    15,    33,
     -14,   -14,    25,   -14,    -4,    20,    34,    35,    36,    38,
     -14,   -14,    40,    41,   -14,    43,   -14,   -14,   -14,   -14
};
...
{
       0,     0,     3,     0,     0,     2,     0,     0,     0,     0,
       0,     0,    14,     0,     4,     1,     0,    19,     0,    18,
      20,     0,     0,     0,     6,     0,     5,     0,     0,     0,
      13,    17,    15,    12,     7,     0,     0,     0,     0,     0,
       9,     8,     0,     0,    16,     0,    11,    10,    21,    22
};
...
{
       7,    15,    11,    24,    12,    40,    27,    25,    17,    18,
      13,     8,     9,    10,    26,    28,    41,    29,     1,     2,
      36,    37,    14,    16,     3,     4,    19,     5,    20,    21,
      23,    33,    22,    30,    31,    32,    34,    35,    38,     0,
      39,     0,    44,    46,    42,    47,    48,    43,    49,    45
};

static const yytype_int8 yycheck[] =
{
      13,     0,     5,     9,     5,     9,    15,    13,     5,     6,
       5,    24,    25,    26,    20,    24,    20,    26,     5,     6,
       5,     6,     5,     5,    11,    12,     5,    14,     5,    13,
       6,     3,    13,     7,     5,     5,     5,     5,     5,    -1,
      15,    -1,     7,     5,    24,     5,     5,    13,     5,    13
};
...
{
       0,     5,     6,    11,    12,    14,    42,    13,    24,    25,
      26,     5,     5,     5,     5,     0,     5,     5,     6,     5,
       5,    13,    13,     6,     9,    13,    20,    15,    24,    26,
       7,     5,     5,     3,     5,     5,     5,     6,     5,    15,
       9,    20,    24,    13,     7,    13,     5,     5,     5,     5
};
...
#line 1365 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 151 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
...
#line 1397 "snazzle.tab.c" /* yacc.c:1646  */
    break;
...
#line 1438 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 204 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
...
#line 1460 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 221 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_name = (yyvsp[-3].str_str);
    char *fld_name = (yyvsp[-1].str_str);
...
#line 1485 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 241 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_name = (yyvsp[-6].str_str);
    char *fld_name = (yyvsp[-4].str_str);
    char *fld_prop = (yyvsp[-2].str_str); 
    char *prop_val = (yyvsp[0].str_str); 
    mcr_chk_tbl_name(tbl_name);
    mcr_chk_tbl_name(fld_name);
    ...
    strcat(g_op, g_buf);
    strcat(g_op, "} \n");
    free_if_non_null((yyvsp[-6].str_str));
...
#line 1513 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 264 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_name = (yyvsp[-4].str_str);
    char *fld_name = (yyvsp[-2].str_str);
    char *fld_prop = (yyvsp[0].str_str); 
    mcr_chk_tbl_name(tbl_name);
    mcr_chk_tbl_name(fld_name);
    mcr_chk_fld_prop(fld_prop);
    strcat(g_op, "{ \n");
...
#line 1539 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 285 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_name = (yyvsp[-2].str_str);
    char *op = (yyvsp[-1].str_vrb); op += 3; // Jump over OP=
    char *str_num_rows = (yyvsp[0].str_int);
    ...
    free_if_non_null((yyvsp[0].str_int));
      }
#line 1568 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 309 "snazzle.y" /* yacc.c:1646  */
    {
  int status = 0;
  char *tbl_name = (yyvsp[-3].str_str);
  char *op = (yyvsp[-1].str_vrb); op += 3; // Jump over OP=
  char *options = (yyvsp[0].str_opt);
  if ( ( strcasecmp(op, "New")        ==  0 ) ||
  ...
  free_if_non_null((yyvsp[-3].str_str));
  free_if_non_null((yyvsp[-1].str_vrb));
  free_if_non_null((yyvsp[0].str_opt));

}
#line 1628 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 364 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_name = (yyvsp[0].str_str);
    mcr_chk_tbl_name(tbl_name);
...
#line 1644 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 376 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_name = (yyvsp[-2].str_str);
    char *fld_name = (yyvsp[0].str_str);
...
#line 1665 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 392 "snazzle.y" /* yacc.c:1646  */
    {
...
#line 1695 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 17:
#line 417 "snazzle.y" /* yacc.c:1646  */
    {
...
#line 1733 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 450 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
...
#line 1754 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 466 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_dst_name = (yyvsp[-2].str_str);
    char *tbl_src_name = (yyvsp[0].str_str);
...
#line 1775 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 482 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_dst_name = (yyvsp[-2].str_str);
    char *tbl_src_name = (yyvsp[0].str_str);
...
#line 1796 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 498 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
...
#line 1832 "snazzle.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 529 "snazzle.y" /* yacc.c:1646  */
    {
    int status = 0;
    char *tbl_dst_name = (yyvsp[-6].str_str);
    char *fld_dst_name = (yyvsp[-4].str_str);
...
#line 1873 "snazzle.tab.c" /* yacc.c:1646  */
    break;


#line 1877 "snazzle.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 566 "snazzle.y" /* yacc.c:1906  */
