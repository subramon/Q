...
assert(cutils.isdir(q_build_dir), "Directory not found: " .. q_build_dir)
assert(cutils.isdir(final_h), "Directory not found: " .. final_h)
assert(cutils.isdir(final_so), "Directory not found: " .. final_so)
